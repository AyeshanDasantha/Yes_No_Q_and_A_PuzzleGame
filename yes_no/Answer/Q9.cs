...
namespace yes_no.Answer
{
    public partial class Q9 : Form
    {
        ...
        private void Q9_Load(object sender, EventArgs e)
        {
            ...
            if (dr.Read())
            {
                textBox1.Text = (dr["quection9"].ToString());
            }
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            string sqlselectquert = "SELECT TOP 1 answer9 from qection where answer9 like '1' ";
            SqlCommand cmd = new SqlCommand(sqlselectquert, con);
            SqlDataReader dr = cmd.ExecuteReader();
            if (dr.Read())
            {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            string sqlselectquert = "SELECT TOP 1 answer9 from qection where answer9 like '0' ";
            SqlCommand cmd = new SqlCommand(sqlselectquert, con);
            SqlDataReader dr = cmd.ExecuteReader();
            if (dr.Read())
            {
