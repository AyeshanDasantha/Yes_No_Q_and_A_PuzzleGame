...
namespace yes_no.Answer
{
    public partial class Q3 : Form
    {
        ...
        private void Q3_Load(object sender, EventArgs e)
        {
            ...
            if (dr.Read())
            {
                textBox1.Text = (dr["quection3"].ToString());
            }
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            string sqlselectquert = "SELECT TOP 1 answer3 from qection where answer3 like '1' ";
            SqlCommand cmd = new SqlCommand(sqlselectquert, con);
            SqlDataReader dr = cmd.ExecuteReader();
            if (dr.Read())
            {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            string sqlselectquert = "SELECT TOP 1 answer3 from qection where answer3 like '0' ";
            SqlCommand cmd = new SqlCommand(sqlselectquert, con);
            SqlDataReader dr = cmd.ExecuteReader();
            if (dr.Read())
            {
